...
export default function ShopItem() {
    ...
    const onCartButtonClick = () => {
        let productVariation = data?.variations?.find((el: IProduct)=>{return el.options.size === size && el.options.color === color})
        trigger({
            ...
            setSnackBarOpen(true)
            setSnackBarMessage("Non posso aggiungere " + data?.title + " al carrello")
        })
    }
